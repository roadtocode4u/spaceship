...
```js
 ...
 > localstorage.setItem('Anand', obj)
 < undefined

 > localstorage.setItem('Anand', JSON.stringfy(obj))
 < undefined

 > const studentObj = localStorage.getItem('Anand')
 < undefined
 ...
 > let properObj = JSON.parse(localStorage.getItem('Anand'))
 < undefined
