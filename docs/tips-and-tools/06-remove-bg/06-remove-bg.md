...
<img src="/tip-and-tools/06/screenshot-1.png" alt="output-2" width="600px"/>

2. Directly drag and drop the file from your computer to the remove.bg's upload area.

<img src="/tip-and-tools/06/screenshot(2).png" alt="output-2" width="600px"/>

3. Copy-Paste the image url from the web.

<img src="/tip-and-tools/06/screenshot(3).png" alt="output-2" width="600px"/>
...
<img src="/tip-and-tools/06/screenshot(4).png" alt="output-2" width="600px"/>

- You can now download the edited image from the download option as shown:

<img src="/tip-and-tools/06/screenshot(5).png" alt="output-2" width="600px"/>

- If you want, you can also edit the image further, by choosing the edit option:

<img src="/tip-and-tools/06/screenshot(5).png" alt="output-2" width="600px"/>

<img src="/tip-and-tools/06/screenshot(6).png" alt="output-2" width="600px"/>
...
<img src="/tip-and-tools/06/screenshot(7).png" alt="output-2" width="600px"/>

## Subscription Plan

- Remove.bg also provides subscriptions plan based on the users's requirements.

<img src="/tip-and-tools/06/screenshot(8).png" alt="output-2" width="600px"/>
